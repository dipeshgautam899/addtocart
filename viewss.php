...
<div class="col-md-1">
          ...
          <a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions">
            <img src="img/cart.webp" alt="Add to cart">
          </a>

            <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
              aria-labelledby="offcanvasWithBothOptionsLabel">
              <div class="offcanvas-header">
                <h3 class="offcanvas-title text-primary" id="offcanvasWithBothOptionsLabel"><strong>Cart</strong>
                </h3>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="" method="POST">
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <button type="submit" class="btn btn-danger remove-from-cart" name="remove-from-cart"><i
